...
def resumo_contas_pagar(
    ...
    contraparte: Optional[List[str]] = Query(None, description="Fornecedors (repetível)"),
    ...
    """KPIs, evolução, categorias e ranking de fornecedor — do recorte inteiro.

    A tela baixava a tabela toda para calcular isto no navegador: 7,9 MB por
    ...
    return resumo_de_contas(
        db,
        tabela="contas_pagar",
        campo_emissao="data_emissao",
        quitadas=QUITADAS_A_PAGAR,
        situacoes=situacao,
...
def pagina_contas_pagar(
    ...
    busca: Optional[str] = Query(
        None, max_length=120, description="Procura em fornecedor, categoria, documento e histórico"
    ),
